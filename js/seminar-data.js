...
const seminarsData = {
    ...
    "change": {
        ...
        heroImage: "assets/hero-meeting.jpg",
        content: {
            intro: "Nichts ist beständiger als der Wandel. Unternehmen müssen sich ständig anpassen – und die Mitarbeiter müssen diesen Weg mitgehen. In diesem Seminar lernen Sie, Veränderungsprozesse nicht nur zu verstehen, sondern aktiv zu gestalten.",
            ziele: [
                "Wie Sie mentale Klarheit und Stärke erreichen können",
                "Konstruktiver, aktiver Umgang mit Veränderungen",
                "Beeinflussbare von nicht beeinflussbaren Lebensbereichen unterscheiden",
                "Behindernde Suggestionen loslassen und Mut zu neuen Verhaltensmustern fassen",
                "Bedeutung von Zielen für die Lebenskompetenz"
            ],
            inhalte: "Phasen von Veränderungsprozessen. Umgang mit Widerständen. Kommunikation im Wandel. Die Rolle der Führungskraft in der Veränderung. Fallbearbeitung und Transfer in die eigene Praxis.",
            nutzen: "Sie können Veränderungsprozesse professioneller planen und begleiten und erhöhen die Akzeptanz bei den Betroffenen. Sie entwickeln Gelassenheit im Umgang mit Dynamik.",
            zielgruppe: "Führungskräfte, Change Agents, Projektleiter und alle, die Veränderungen gestalten."
        }
    },
    ...
    "rhetorik": {
        ...
        heroImage: "assets/hero-meeting.jpg",
        content: {
            intro: "Seriös und verständlich informieren und dabei eine lebendige Wirkung erzielen: Wie können Sie Zuhörer mitnehmen und gewinnen? Was macht Ihre Sprache, Ihr Sprechen verständlich und klar? In diesem Seminar arbeiten wir an Ihrer Wirkung.",
            ziele: [
            ...
            inhalte: "Aufbau einer Rede/Präsentation. Körpersprache und Stimme. Medieneinsatz. Umgang mit Lampenfieber. Interaktion mit dem Publikum. Wir arbeiten mit Videoanalyse für maximalen Lernerfolg.",
